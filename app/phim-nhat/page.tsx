...
export default async function PhimNhatPage({ searchParams }: PageProps) {
  const params = await searchParams;
  const page = parseInt(params.page || "1", 10);
  const moviesData = await getDanhSach("phim-moi", { page, limit: 30, country: "nhat-ban" });
